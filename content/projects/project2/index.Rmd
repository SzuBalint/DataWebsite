...
#I am using my laptop and desktop with two different wds
wd <- try(setwd("C:/Users/Bálint/OneDrive/Projekt/ISGModelling"))

if (class(wd)=="try-error") {
setwd("C:/Users/Ildiko/OneDrive/Projekt/ISGModelling")
} else {
setwd(wd)
}
...
MiceData <- mice(Data,m=5,maxit=50,meth='pmm',seed=500)
...
MiceData <- mice(Loans[,-1],m=5,maxit=50,meth='pmm',seed=500)
